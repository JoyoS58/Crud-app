    ...
    @section('content')
         <div class="card p-4 shadow-lg border-1">
              <div class="container py-4">
                    ...
                    <!-- Add Activity Button -->
                    <a href="{{ route('userActivities.create') }}" class="btn btn-primary mb-3 btn-lg">
                                         ...
                                         @foreach ($activities as $index => $activity)
                                              <tr>
                                                    ...
                                                    <td class="text-center">
                                                         <!-- View Button -->
                                                         <a href="{{ route('userActivities.show', $activity->activity_id) }}"
                                                              class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top"
                                                              title="View Activity">
                                                              <i class="fas fa-eye"></i> View
                                                         </a>
                                                         <!-- Edit Button -->
                                                         <a href="{{ route('userActivities.edit', $activity->activity_id) }}"
                                                              class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top"
                                                              title="Edit Activity">
                                                              <i class="fas fa-edit"></i> Edit
                                                         </a>
                                                         <!-- Delete Button with Confirmation -->
                                                         <form action="{{ route('userActivities.destroy', $activity->activity_id) }}" method="POST"
                                                              class="d-inline"
...
This will ensure that only the activities of the logged-in user are displayed on the activities management page.
